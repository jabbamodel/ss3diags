...
SSdiagsMCMC_old <- function (mcmcdir,Bref=c("MSY","Btrg"),Fref=c("MSY","Ftrg"),run="MCMC",Fstarter =  c("_abs_F","(F)/(Fmsy)","Fstd_Btgt"),forecast=FALSE,plot=TRUE,thin = 1, biomass = "SSB", 
