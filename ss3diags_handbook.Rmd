...
sspar(mfrow=c(1,2),plot.cex=0.8)
hcl = SSplotHCxval(retroC.phk,subplots="age",add=T,verbose=F,ylimAdj = 1.3,legendcex = 0.7,indexselect = c(1,2))
...
<br>
```{r eval=FALSE}
r4ss::SS_doRetro(masterdir=dir.retro, oldsubdir="", newsubdir="", years=start.retro:-end.retro,extras = "-nohess")
```
<br>
